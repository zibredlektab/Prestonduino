 ...
 */
// Serial (EDBG)
#define PIN_SERIAL_RX       (31ul) // I don't think we care about this
#define PIN_SERIAL_TX       (30ul) // same
...
#define PAD_SPI_TX           SPI_PAD_2_SCK_3 // MOSI pad 2, SCK pad 3
#define PAD_SPI_RX           SERCOM_RX_PAD_1 // MISO not used
